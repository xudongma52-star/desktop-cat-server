#!/usr/bin/env bash
set -Eeuo pipefail
release_id=dusk-entry-20260922
web_root=/www/wwwroot/maxmeme.cn
upload_root=/opt/desktop-cat/uploads/dusk-entry-20260922
backup_root=/opt/desktop-cat/backups/dusk-entry-20260922
...
curl -fsS --resolve maxmeme.cn:443:127.0.0.1 https://maxmeme.cn/ | grep -q 'index-BqD56n6H.js'
for asset in dusk-writer-round-CPYa_ypq.webp index-CCnigaeY.css; do
