...
release_id=dusk-gsap-v9-20260923-095348
web_root=/www/wwwroot/maxmeme.cn
upload_root=/opt/desktop-cat/uploads/dusk-gsap-v9-20260923-095348
backup_root=/opt/desktop-cat/backups/dusk-gsap-v9-20260923-095348
...
curl -fsS --resolve maxmeme.cn:443:127.0.0.1 https://maxmeme.cn/ | grep -q 'index-jSWAfq3R.js'
for asset in index-8qEAIpoF.css dusk-arrival-CqgxIRfP.mp4 dusk-arrival-Cfg5NJfK.webm dusk-writer-round-CPYa_ypq.webp; do
