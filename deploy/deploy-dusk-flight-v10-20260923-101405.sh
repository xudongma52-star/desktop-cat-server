...
release_id=dusk-flight-v10-20260923-101405
web_root=/www/wwwroot/maxmeme.cn
upload_root=/opt/desktop-cat/uploads/dusk-flight-v10-20260923-101405
backup_root=/opt/desktop-cat/backups/dusk-flight-v10-20260923-101405
...
curl -fsS --resolve maxmeme.cn:443:127.0.0.1 https://maxmeme.cn/ | grep -q 'index-D3HiOxUq.js'
for asset in index-COx9CxQ4.css dusk-arrival-BK-_0J78.mp4 dusk-arrival-DBNUKr4w.webm dusk-writer-round-CPYa_ypq.webp; do
