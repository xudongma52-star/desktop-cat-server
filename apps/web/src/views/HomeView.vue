...
<template>
  <div class="home-view">
      ...
      <section class="future" aria-labelledby="future-title">
        <div class="section-top"><h2 id="future-title">这个角落，已经开始有了故事</h2><span class="muted">慢慢长大就好</span></div>
        <div class="feature-grid">
          <article><span class="feature-number">01 / 记录</span><h3>今天，想留下什么？</h3><p>日记、心得，或是实习中终于弄明白的一件事。</p><RouterLink class="text-link" to="/records/new">现在去写 →</RouterLink></article>
          <article><span class="feature-number">02 / 回忆</span><h3>重温那些小小的温暖</h3><p>挑选值得珍藏的文章，在疲惫时陪自己歇一会儿。</p><RouterLink class="text-link" to="/records">管理记录 →</RouterLink></article>
